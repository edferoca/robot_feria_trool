...
# pide al usraio el ingreso de el tiempo que desea que el bot atue
tiempo_1 = float(input("Ingresa el tiempo en horas: "))
...
# Convertir el tiempo ingresado a tiempo real (en unidades de 40)
tiempo_real = tiempo_1 * 40

print(f"vueltaas a realizar : {tiempo_real}")
print(f"Comienza la recoleccion")

for i in range(int(tiempo_real)):
    while 1:
